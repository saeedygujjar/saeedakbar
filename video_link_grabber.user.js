// ==UserScript==
// @name         Video_Link_Grabber
// @namespace    https://github.com/saeedygujjar/
// @version      1.0
// @description  Clone of inject2Downliad User Script
...
// @grant        none
// @license      MIT License
// @downloadURL  https://github.com/saeedygujjar/main/raw/main/video_link_grabber.user.js
// @updateURL    https://github.com/saeedygujjar/main/raw/main/video_link_grabber.user.js
...
(function() {
    ...
    var config_template = {
        ...
        blacklist: {
            ...
            default: [
                ...
                "youtube.com.com"              // Conflicts with $f
            ].join("\n")
        }
    };
    ...
    if (window.location.hostname.toLowerCase() == "anonymousmeerkat.github.io" &&
        ...
        run_on_load(function() {
            var text = [
                "<html><head><title>Video_Link_Grabber Preferences</title></head><body style='margin:0;padding:1em'>",
                "<div style='width:100%'><h2>Video_Link_Grabber</h2></div>",
                "<div id='prefs'></div>",
    ...
    function i2d_show_url(namespace, url, description) {
        ...
        run_on_load(function() {
            ...
            if (!el) {
                ...
                el.style.width = "max(40%, 60em)";
                el.style.height = "max(40%, 60em)";
            ...
            // XXX: why is this needed? test: https://www.w3schools.com/html/mov_bbb.mp4, test video
